      ...
      <section className="pb-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {categoryCrossfade.showSkeleton && (
            <div
              className={`flex flex-nowrap gap-5 overflow-x-auto no-scrollbar overscroll-x-contain touch-auto pb-2 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 transition-opacity duration-300 ease-out ${
            ...
            >
              {filteredBrands.length === 0 ? (
                ...
                <div
                  ...
                  className="flex flex-nowrap gap-5 overflow-x-auto no-scrollbar scrollbar-none overscroll-x-contain touch-auto pb-2 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 cursor-grab active:cursor-grabbing select-none"
                >
